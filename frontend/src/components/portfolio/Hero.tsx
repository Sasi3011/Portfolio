...
import { GITHUB_USERNAME } from "@/lib/constants/social";
...
const MARQUEE_ITEMS = [
  {
    ...
    color: "text-blue-600 border-blue-500/30 bg-blue-500/8",
  },
  {
    Icon: Palette,
    text: "UI/UX Design",
    color: "text-pink-600 border-pink-500/30 bg-pink-500/8",
  },
  {
    Icon: Terminal,
    text: "Clean Code",
    color: "text-emerald-600 border-emerald-500/30 bg-emerald-500/8",
  },
  {
    Icon: Braces,
    text: "React & Node.js",
    color: "text-cyan-600 border-cyan-500/30 bg-cyan-500/8",
  },
  {
    Icon: Sparkles,
    text: "Product Design",
    color: "text-amber-600 border-amber-500/30 bg-amber-500/8",
  },
  {
    Icon: Cpu,
    text: "Scalable Systems",
    color: "text-violet-600 border-violet-500/30 bg-violet-500/8",
  },
  {
    Icon: Globe,
    text: "Web Applications",
    color: "text-sky-600 border-sky-500/30 bg-sky-500/8",
  },
  {
    Icon: MousePointer2,
    text: "Interactive Prototypes",
    color: "text-rose-600 border-rose-500/30 bg-rose-500/8",
  },
];
    ...
    <div className="marquee-mask absolute bottom-0 left-0 right-0 overflow-hidden border-t border-primary/10 bg-primary/5 py-2 sm:py-3.5 flex-shrink-0 z-10 w-full select-none animate-fade-in flex">
      ...
      >
        {items.map(({ Icon, text, color }, i) => (
          ...
          >
            <span
              className={`grid h-6 w-6 place-items-center rounded-md border ${color}`}
            >
...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        style={{ y }}
        className="absolute -top-32 left-1/4 h-[500px] w-[500px] rounded-full bg-primary/25 blur-[120px]"
      />
      <motion.div
        style={{ y: y2 }}
        className="absolute top-1/3 right-0 h-[400px] w-[400px] rounded-full bg-accent/15 blur-[100px]"
      />

      <motion.div
        style={{ opacity }}
        className="relative mx-auto flex w-full max-w-[1400px] flex-col items-center px-2 sm:px-4"
      >
        <motion.div
          initial="hidden"
          animate="show"
          variants={stagger}
          className="grid w-full items-center gap-10 lg:grid-cols-12 lg:gap-16"
        >
          ...
          <div className="flex flex-col items-start text-left lg:col-span-7">
            ...
            <motion.h1
              variants={fadeUp}
              className="hero-headline mt-4 font-bold select-none"
            >
            ...
            >
              I design intuitive interfaces and build production-ready
              full-stack applications - from Figma wireframes to deployed web
              apps.
            </motion.p>
          ...
          >
            <div className="relative w-full max-w-[850px] -ml-4 sm:-ml-10">
              ...
              <div className="relative">
                <div>
                  {data ? (
                    <div className="rounded-2xl border border-slate-200/50 bg-white/80 backdrop-blur-xl p-2 shadow-xl scale-[0.8] sm:scale-[0.85] origin-center">
                    ...
                    <div className="h-[400px] w-full rounded-2xl border border-slate-200/50 bg-white/80 backdrop-blur-xl p-4 shadow-xl flex items-center justify-center">
