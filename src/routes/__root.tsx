...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Sasikiran T.T. — Full Stack Developer and UI/UX Designer building digital products from design to deployment." },
      { name: "author", content: "Sasikiran T.T." },
      { property: "og:title", content: "Sasikiran T.T. | Portfolio" },
      { property: "og:description", content: "Full Stack Developer and UI/UX Designer — design, code, and ship products that matter." },
